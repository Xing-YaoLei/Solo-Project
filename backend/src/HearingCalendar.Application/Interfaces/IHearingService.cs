...
{
    Task<HearingDetailResponse> GetByIdAsync(Guid id, Guid? callerUserId = null);
    Task<PagedResult<HearingListResponse>> GetListAsync(int page, int pageSize, HearingStatus? status = null, DateOnly? fromDate = null, DateOnly? toDate = null, string? courtRoom = null, bool? conflictFlagged = null, Guid? callerUserId = null);
