...
export default function SettlementTrendChart({ data, onPeriodClick }: SettlementTrendChartProps) {
  const option = {
    ...
    legend: {
      data: ['结算总额', '拒付-待处理', '拒付-处理中', '拒付-已解决', '训练完成率', '拒付率'],
      top: 4,
    ...
    series: [
      ...
      },
      {
        ...
        type: 'bar',
        stack: 'rejection',
        data: data.map((d) => d.rejectedPendingAmount),
        barWidth: 14,
      ...
      },
      {
        ...
        type: 'bar',
        stack: 'rejection',
        data: data.map((d) => d.rejectedProcessingAmount),
        barWidth: 14,
      ...
      },
      {
        ...
        type: 'bar',
        stack: 'rejection',
        data: data.map((d) => d.rejectedResolvedAmount),
        barWidth: 14,
