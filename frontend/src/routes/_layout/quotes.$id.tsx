...
import { feeTypeOptions, formatCurrency, formatFileSize, getFeeTypeLabel, attachmentCategoryOptions, getAttachmentCategoryLabel, formatDateTime } from '../../../utils/format'
import dayjs from 'dayjs'
import type { QuoteDetail, Attachment } from '../../../types'

export const Route = createFileRoute('/_layout/quotes/$id')({
