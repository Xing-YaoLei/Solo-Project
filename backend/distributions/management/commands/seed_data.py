...
class Command(BaseCommand):
    ...
    def _create_students(self):
        ...
        students_data = [
            ("张小明", "初一(2)班", "13800138001", "13900139001", "active"),
            ("李华", "初一(2)班", "13800138002", "13900139002", "active"),
            ("王芳", "初二(1)班", "13800138003", "13900139003", "active"),
            ("刘洋", "初二(1)班", "13800138004", "13900139004", "active"),
            ("陈静", "初一(1)班", "13800138005", "13900139005", "active"),
            ("杨帆", "初三(2)班", "13800138006", "13900139006", "active"),
            ("赵敏", "初三(2)班", "13800138007", "13900139007", "active"),
            ("孙浩然", "初一(3)班", "13800138008", "13900139008", "active"),
            ("周雨桐", "初二(3)班", "13800138009", "13900139009", "graduated"),
            ("吴磊", "初三(1)班", "13800138010", "13900139010", "transferred"),
            ("郑天琪", "初三(1)班", "13800138011", "13900139011", "graduated"),
        ]
        for name, class_name, contact, guardian, status in students_data:
