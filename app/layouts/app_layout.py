...
def create_app_layout():
    ...
    return dbc.Container([
        ...
        dcc.Store(id="selected-order-id", data=None),
        dcc.Store(id="current-order-data", data=None),
                            ...
                            dbc.Spinner(
                                dash_table.DataTable(
                                    ...
                                    style_data_conditional=[
                                        {
                                            "if": {"filter_query": "{has_parts_shortage} = '是'"},
                                            "backgroundColor": "#fff3cd",
                                            "color": "#856404",
                                        },
                                        {
                                            "if": {"filter_query": "{is_rework} = '是'"},
                                            "color": "#dc3545",
                                            "fontWeight": "bold",
                                        },
                                        {
                                            "if": {"filter_query": "{status} = '配件待料'"},
                    ...
                    dbc.Card([
                        ...
                        dbc.CardBody([
                            dash_table.DataTable(
                                ...
                                style_data_conditional=[
                                    {
                                        "if": {"filter_query": "{status} = '缺货'"},
                                        "backgroundColor": "#fff3cd",
                                        "color": "#856404",
                                    },
                                    {
                                        "if": {"filter_query": "{item_type} = '配件'"},
