...
{
    /// <inheritdoc />
    public partial class IdentityGuidMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActualAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    AmountConsistency = table.Column<int>(type: "int", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ScheduleTasks_AspNetUsers_AssignedToId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApprovalNodes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ApprovalNodes_AspNetUsers_ApproverId",
                        column: x => x.ApproverId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ApprovalNodes_Documents_DocumentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaterialsBefore = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MaterialsAfter = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DocumentHistories_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DocumentItems_Materials_MaterialId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PaymentRecords_AspNetUsers_RecordedById",
                        column: x => x.RecordedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PaymentRecords_Documents_DocumentId",
                        column: x => x.DocumentId,
                        principalTable: "Documents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_PaymentRecords_Projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApprovalNodes_ApproverId",
                table: "ApprovalNodes",
                column: "ApproverId");

            migrationBuilder.CreateIndex(
                name: "IX_ApprovalNodes_DocumentId",
                table: "ApprovalNodes",
                column: "DocumentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DocumentHistories_CreatedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DocumentItems_MaterialId",
                table: "DocumentItems",
                column: "MaterialId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentRecords_ProjectId",
                table: "PaymentRecords",
                column: "ProjectId");
