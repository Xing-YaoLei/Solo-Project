import { IsString, IsNotEmpty, MinLength, MaxLength, IsEmail, IsOptional, IsEnum, IsBoolean, IsPhoneNumber } from 'class-validator';
import { ApiProperty, ApiPropertyOptional } from '@nestjs/swagger';
import { UserRole } from '@prisma/client';

export class CreateUserDto {
  @ApiProperty({ description: '用户名', example: 'newuser', minLength: 3, maxLength: 30 })
