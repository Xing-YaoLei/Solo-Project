...
export const performanceApi = {
  ...
  getDetail: (id: number) => api.get(`/performances/${id}`),
...
export const sponsorApi = {
  ...
  getDetail: (id: number) => api.get(`/sponsors/${id}`),
...
export const ticketApi = {
  ...
  getDetail: (id: number) => api.get(`/ticket-types/${id}`),
...
export const verificationApi = {
  ...
  getDetail: (id: number) => api.get(`/verifications/${id}`),
...
export const disputeApi = {
  ...
  getDetail: (id: number) => api.get(`/disputes/${id}`),
